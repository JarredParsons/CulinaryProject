...
Namespace Base
    ...
    Public MustInherit Class LeftTabControl
        ...
        Protected Overrides Sub OnControlAdded(e As ControlEventArgs)
            ...
            e.Control.ForeColor = ColorFromHex("#72778D")
...
Public Class StrafeTabControl
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        G.Clear(ColorFromHex("#2E3243"))
        For I As Integer = 0 To TabPages.Count - 1
            BaseRect = GetTabRect(I)
            If TabPages(I).Tag = String.Empty Then
                Using TextColor As New SolidBrush(ColorFromHex("#6A7279")), TextFont As New Font("Segoe UI", 7, FontStyle.Bold), Border As New Pen(ColorFromHex("#2B2F33"))
                    G.DrawString(TabPages(I).Text.ToUpper, TextFont, TextColor, New Point(BaseRect.X + 25 + (ItemSize.Height - 180), BaseRect.Y + 16))
                End Using
            Else
                If SelectedIndex = I Then
                    Using Background As New SolidBrush(ColorFromHex("#272938")), TextColor As New SolidBrush(ColorFromHex("#E4E4E5")), TextFont As New Font("Segoe UI semibold", 9)
                    ...
                    End Using
                    Using RectBack As New SolidBrush(ColorFromHex("#2E3243")), RectBorder As New Pen(ColorFromHex("#232532")), LeftArrow As Image = Image.FromStream(New IO.MemoryStream(Convert.FromBase64String(B64Arrow)))
                        G.FillPath(RectBack, RoundRect(New Rectangle(BaseRect.X + 148, BaseRect.Y + 11, 17, 17), 3))
                        G.DrawPath(RectBorder, RoundRect(New Rectangle(BaseRect.X + 148, BaseRect.Y + 11, 17, 17), 3))
                        G.DrawImage(LeftArrow, New Point(BaseRect.X + 153, BaseRect.Y + 15))
                    End Using
                Else
                    Using TextColor As New SolidBrush(ColorFromHex("#848AA0")), TextFont As New Font("Segoe UI semibold", 9)
                        G.DrawString(TabPages(I).Text, TextFont, TextColor, New Point(BaseRect.X + 55, BaseRect.Y + 11))
                    End Using
                End If
                If Not String.IsNullOrEmpty(TabPages(I).Tag) Then
                    Try
                        Using Border As New Pen(ColorFromHex(TabPages(I).Tag)) With {
                   .Width = 3}
                            G.DrawPath(Border, RoundRect(New Rectangle(BaseRect.X + 35, BaseRect.Y + 15, 9, 9), 2))
                        End Using
                    Catch
                    End Try
                End If
    ...
    Protected Overrides Sub OnSelecting(e As TabControlCancelEventArgs)
        ...
        If Not IsNothing(e.TabPage) Then
            If e.TabPage.Tag = String.Empty Then
                e.Cancel = True
            Else
                OverIndex = -1
            End If
        ...
        For I As Integer = 0 To TabPages.Count - 1
            ...
            If SelectedIndex = I Then
                ...
                If String.IsNullOrEmpty(TabPages(I).Tag) Then
                    ...
                    Using DefColor As New SolidBrush(ColorFromHex("#40B1D0")) ', DefBorder As New Pen(ColorFromHex("#3CA3C3"))
                        G.FillEllipse(DefColor, New Rectangle(BaseRect.X + 5, BaseRect.Y + 5, 9, 9))
                    End Using

                ElseIf TabPages(I).Tag.ToString.Length = 7 Then

                    Using DefColor As New SolidBrush(ColorFromHex(TabPages(I).Tag))
                        G.FillEllipse(DefColor, New Rectangle(BaseRect.X + 5, BaseRect.Y + 5, 9, 9))
                    End Using
            ...
            Else
                ...
                Using DefColor As New SolidBrush(ColorFromHex("#C8C8C8")), DefBorder As New Pen(ColorFromHex("#C3C3C3"))
                    G.FillEllipse(DefColor, New Rectangle(BaseRect.X + 5, BaseRect.Y + 5, 9, 9))
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            If Not Checked Then
                ...
                Using Background As New SolidBrush(ColorFromHex("#C8C8C8")), Border As New Pen(ColorFromHex("#C3C3C3")), SquareBorder As New Pen(ColorFromHex("#C3C3C3"))
                    G.FillRectangle(Background, FullRectangle(Size, True))
                    G.DrawRectangle(Border, FullRectangle(Size, True))
            ...
            Else
                ...
                Using Background As New SolidBrush(ColorFromHex("#40B1D0")), Border As New Pen(ColorFromHex("#3CA3C3")), SquareBorder As New Pen(ColorFromHex("#3CA3C3"))
                    G.FillRectangle(Background, FullRectangle(Size, True))
                    G.DrawRectangle(Border, FullRectangle(Size, True))
        ...
        Else
            ...
            If Not Checked Then
                ...
                Using Background As New SolidBrush(ColorFromHex("#E8E8E8")), Border As New Pen(ColorFromHex("#DEDEDE")), SquareBorder As New Pen(ColorFromHex("#E0E0E0"))
                    G.FillRectangle(Background, FullRectangle(Size, True))
                    G.DrawRectangle(Border, FullRectangle(Size, True))
            ...
            Else
                ...
                Using Background As New SolidBrush(ColorFromHex("#A0C4CE")), Border As New Pen(ColorFromHex("#9FC1CB")), SquareBorder As New Pen(ColorFromHex("#9FC1CB"))
                    G.FillRectangle(Background, FullRectangle(Size, True))
                    G.DrawRectangle(Border, FullRectangle(Size, True))
...
Public Class StrafeCheckBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Border As New Pen(ColorFromHex("#C8C8C8")), TextColor As New SolidBrush(ColorFromHex("#72778D")), TextFont As New Font("Segoe UI", 9)
            ...
            If Checked Then
                ...
                Using Check As New SolidBrush(ColorFromHex("#40B1D0")), CheckBorder As New Pen(ColorFromHex("#3CA3C3"))
        ...
        Else
            ...
            Using Border As New Pen(ColorFromHex("#E8E8E8")), TextColor As New SolidBrush(ColorFromHex("#B8BDC9")), TextFont As New Font("Segoe UI", 9)
                G.DrawRectangle(Border, New Rectangle(0, 0, 16, 16))
                G.DrawString(Text, TextFont, TextColor, New Point(22, 0))
            End Using
            ...
            If Checked Then
                ...
                Using Check As New SolidBrush(ColorFromHex("#A0C4CE")), CheckBorder As New Pen(ColorFromHex("#9FC1CB"))
                    G.FillRectangle(Check, New Rectangle(3, 3, 10, 10))
                    G.DrawRectangle(CheckBorder, New Rectangle(3, 3, 10, 10))
                End Using
...
Public Class StrafeHeader
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using TextColor As New SolidBrush(ColorFromHex("#4E5260")), TextFont As New Font("Segoe UI semibold", 15)
...
Public Class StrafeSeparator
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using SepColor As New Pen(ColorFromHex("#ECEFF3"))
...
Public Class StrafeCircular
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using ProgressColor As New Pen(ColorFromHex("#40B1D0"), 4), Background As New Pen(ColorFromHex("#E8E8E8"), 4)
        ...
        Using TextFont As New Font("Segoe UI", 9, FontStyle.Bold), TextColor As New SolidBrush(ColorFromHex("#4E5260"))
            CenterString(G, Progress, TextFont, TextColor.Color, New Rectangle(1, 1, Width, Height + 1))
        End Using

        If ShowMax Then

            Using TextFont As New Font("Segoe UI", 7, FontStyle.Bold), TextColor As New SolidBrush(ColorFromHex("#B8BDC9"))
                CenterString(G, Max, TextFont, TextColor.Color, New Rectangle(0, 11, Width, Height + 1))
            End Using
...
Public Class StrafeProgressBar
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Background As New SolidBrush(ColorFromHex("#40B1D0")), DefBackground As New SolidBrush(ColorFromHex("#E8E8E8"))
            G.FillRectangle(DefBackground, FullRectangle(Size, True))
        ...
        If Enabled Then
            ...
            Select Case State
                ...
                Case MouseState.Over
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#F0F0F0")), Border As New Pen(ColorFromHex("#C8C8C8"))
                        G.FillRectangle(Background, FullRectangle(Size, True))
                        G.DrawRectangle(Border, FullRectangle(Size, True))
                    End Using
                ...
                Case MouseState.Down
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#E6E6E6")), Border As New Pen(ColorFromHex("#C8C8C8"))
                        G.FillRectangle(Background, FullRectangle(Size, True))
                        G.DrawRectangle(Border, FullRectangle(Size, True))
                    End Using
            ...
            Using TextFont As New Font("Segoe UI", 9), TextColor As New SolidBrush(ColorFromHex("#72778D"))
                CenterString(G, Text, TextFont, TextColor.Color, FullRectangle(Size, False))
            End Using

        Else

            Using Border As New Pen(ColorFromHex("#E8E8E8"))
                G.DrawRectangle(Border, FullRectangle(Size, True))
            End Using

            Using TextFont As New Font("Segoe UI", 9), TextColor As New SolidBrush(ColorFromHex("#B8BDC9"))
                CenterString(G, Text, TextFont, TextColor.Color, FullRectangle(Size, False))
            End Using
...
Public Class StrafeNumericUpDown
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using SignColor As New SolidBrush(ColorFromHex("#72778D")), SignFont As New Font("Marlett", 10)
...
Public Class StrafeGroupBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        TextMeasure = G.MeasureString(Text, Font)

        If Enabled Then

            Using Border As New Pen(ColorFromHex("#DBDBDB"))
                G.DrawPath(Border, RoundRect(New Rectangle(0, 10, Width - 1, Height - 11), 2))
            End Using

            Using TextBrush As New SolidBrush(ColorFromHex("#889399")), TextFont As New Font("Segoe UI", 7, FontStyle.Bold)
                G.FillRectangle(Brushes.White, New Rectangle(4, 2, CInt(TextMeasure.Width + 8), CInt(TextMeasure.Height + 1)))
                G.DrawString(Text.ToUpper, TextFont, TextBrush, New Point(5, 4))
            End Using

        Else

            Using Border As New Pen(ColorFromHex("#ECECEC"))
                G.DrawPath(Border, RoundRect(New Rectangle(0, 10, Width - 1, Height - 11), 2))
            End Using

            Using TextBrush As New SolidBrush(ColorFromHex("#E1E1E1")), TextFont As New Font("Segoe UI", 7, FontStyle.Bold)
                G.FillRectangle(Brushes.White, New Rectangle(4, 2, CInt(TextMeasure.Width + 8), CInt(TextMeasure.Height + 1)))
                G.DrawString(Text.ToUpper, TextFont, TextBrush, New Point(5, 4))
            End Using
